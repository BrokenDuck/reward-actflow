...
import numpy as np
import torch
from diffusiongym import construct_env, D
...
def main(args):
    ...
    apt = TaskAgnostic(problem_setup=problem_setup, config=config, logger=logger)
    ...
    def explore_loop(self, num_iterations: int, samples_per_iter: int):
        ...
        for i in range(num_iterations):
            ...
            with self._timer("visualize"):
                ...
                metrics["uncertainty"] = batch.rewards.mean().item()
