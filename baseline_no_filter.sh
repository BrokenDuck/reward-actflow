...
#SBATCH --output=output/baseline_no_filter.out
#SBATCH --error=output/baseline_no_filter.err
...
OUTDIR=/cluster/scratch/$USER/baseline_no_filter_initinvalid_${INITIAL_MODEL_INVALID}
mkdir -p "$OUTDIR"
