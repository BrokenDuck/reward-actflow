...
#SBATCH --output=output/baseline_with_filter_%A_%a.out
#SBATCH --error=output/baseline_with_filter_%A_%a.err
...
OUTDIR=/cluster/scratch/$USER/baseline_with_filter_initinvalid_${INITIAL_MODEL_INVALID}/seed_${SEED}
mkdir -p "$OUTDIR"
